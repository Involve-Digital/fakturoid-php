...
class AuthProviderTest extends TestCase
{
    public function testAuthenticationUrl(): void
    {
        ...
        $authProvider = new AuthProvider('userAgent', 'clientId', 'clientSecret', 'redirectUri', $requester);
    ...
    public function testAuthorizationCodeReAuthWithEmptyRefreshCode(): void
    {
        ...
        $credentials->method('getAuthType')
            ->willReturn(AuthTypeEnum::getAuthorizationCodeFlowInstance());
        $credentials->method('getAccessToken')
            ->willReturn('access_token');
        $credentials->method('getRefreshToken')
            ->willReturn(null);

        $authProvider = new AuthProvider('userAgent', 'clientId', 'clientSecret', null, $requester);
    ...
    public function testAuthorizationCodeReAuth(): void
    {
        ...
        $authProvider = new AuthProvider('userAgent', 'clientId', 'clientSecret', null, $client);
    ...
    public function testClientCredential(): void
    {
        ...
        /** @var CredentialCallback $credentialCallback */
        $authProvider->setCredentialsCallback($credentialCallback);
        $credentials = $authProvider->auth(AuthTypeEnum::getClientCredentialsCodeInstance());
        ...
        $this->assertEquals(AuthTypeEnum::getClientCredentialsCodeInstance(), $credentials->getAuthType());
    }
    ...
    public function testClientCredentialWithEmptyResponse(): void
    {
        ...
        $authProvider->auth(AuthTypeEnum::getClientCredentialsCodeInstance());
    }
    ...
    public function testAuthorizationCodeWithoutCode(): void
    {
        ...
        $authProvider->auth(AuthTypeEnum::getAuthorizationCodeFlowInstance());
    }
    ...
    public function testRevokeClientCredentials(): void
    {
        ...
        $credentials = $this->createMock(Credentials::class);
        $credentials->method('getAuthType')
            ->willReturn(AuthTypeEnum::getClientCredentialsCodeInstance());
        $authProvider = new AuthProvider('userAgent', 'clientId', 'clientSecret', null, $client);
    ...
    public function testAuthorizationCodeSimple(): void
    {
        ...
        $client
            ...
            ->method('sendRequest')
            ->willReturn($responseInterface);
        $authProvider = new AuthProvider('userAgent', 'clientId', 'clientSecret', 'redirectUri', $client);
        ...
        $this->assertEquals(AuthTypeEnum::getAuthorizationCodeFlowInstance(), $credentials->getAuthType());
    }
    ...
    public function testAuthorizationCode(): void
    {
        ...
        $credentials = $authProvider->auth(AuthTypeEnum::getAuthorizationCodeFlowInstance());
        $this->assertInstanceOf(Credentials::class, $credentials);
        $this->assertEquals('access_token', $credentials->getAccessToken());
        $this->assertEquals('refresh_token', $credentials->getRefreshToken());
        $this->assertEquals(AuthTypeEnum::getAuthorizationCodeFlowInstance(), $credentials->getAuthType());
